...
int main(int argc, char *argv[]) {
    ...
    if (args.mode == MODE_GENERATE) {
        ...
        if (args.sort_type == SORT_ASC) {
             gnome_sort(&stack, compare_publications); //Обратите внимание: не &compare_publications
        } else {
            gnome_sort_desc(&stack, compare_publications);  //Обратите внимание: не &compare_publications
        }
